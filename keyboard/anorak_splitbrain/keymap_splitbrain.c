...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    KEYMAP_ISO(\
        ...
        TRNS, TRNS, TRNS, TRNS, CALC, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,             TRNS, TRNS, TRNS,   \
        TRNS, TRNS, TRNS, TRNS, TRNS,                   TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,       TRNS, TRNS, TRNS  )
};
...
const uint16_t PROGMEM fn_actions[] =
{
	...
	[6] = ACTION_FUNCTION_OPT(KIIBOHD_FUNCTION_Backlight_Select_Region, BACKLIGHT_CONTROLS), //BACKLIGHT_REGION_CONTROLS
	[7] = ACTION_FUNCTION_OPT(KIIBOHD_FUNCTION_Backlight_Select_Region, BACKLIGHT_OTHER),    //BACKLIGHT_REGION_OTHER
	[8] = ACTION_FUNCTION_OPT(KIIBOHD_FUNCTION_Backlight_Select_Region, BACKLIGHT_LOGO),     //BACKLIGHT_REGION_LOGO
    [9] = ACTION_FUNCTION(KIIBOHD_FUNCTION_Backlight_Decrease_Region),
   [10] = ACTION_FUNCTION(KIIBOHD_FUNCTION_Backlight_Increase_Region),
   [11] = ACTION_MACRO(KIIBOHD_MACRO_EXTRA_LEFT),
   [12] = ACTION_MACRO(KIIBOHD_MACRO_EXTRA_RIGHT),
};
