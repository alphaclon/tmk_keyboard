...
#include "../../backlight/gfx/gfxfont.h"
#include "../../backlight/gfx/Print.h"

class Adafruit_GFX : public Adafruit_Print
{
...
public:
    ...
    void initButton(Adafruit_GFX *gfx, int16_t x, int16_t y, uint8_t w, uint8_t h, uint16_t outline, uint16_t fill,
